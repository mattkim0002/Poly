...
ENABLE_MOMENTUM_CLAUDE = False     # Strategy 3: momentum + Claude Sonnet gate (OFF — unverified EV)
ENABLE_BINANCE_LAG = False         # Strategy 4: Binance-lag directional (OFF — unverified EV)
